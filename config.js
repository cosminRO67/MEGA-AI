...
//
global.botname = process.env.BOTNAME || 'ANONIM';
global.pairingNumber = process.env.BOT_NUMBER || '0770811929' ;  // put your number here
global.SESSION_ID = process.env.SESSION_ID || 'XIY1CQRK#P0_x34FOuFpJejYE9Dq5S3DhuYKXNkAoUocpkntx4qU' ;  // put your session id here
